...
namespace TechMove1._3.Tests.Services
{
    ...
    {
        [Fact]
        public void ValidateContract_AllowsActiveContracts_NoException()
        {
        ...
        [Fact]
        public void ValidateContract_Throws_ForExpiredStatus()
        {
            var svc = new ServiceRequestService();
            var contract = new Contract
            {
        ...
        [Fact]
        public void ValidateContract_Throws_ForOnHoldStatus()
        {
            var svc = new ServiceRequestService();
            var contract = new Contract
            {
